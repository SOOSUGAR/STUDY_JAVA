...
public class TreeSetTest04 {
	public static void main(String[] args) {
		...
		// headSet() : 입력값보다 작은 값을 가진 부분셋을 생성
		SortedSet<Integer> set3 = set.headSet(87);
		System.out.println("87점보다 작은 값을 가진 부분셋 : " + set3); // 87을 포함하지 않음
		
		SortedSet<Integer> set4 = set.headSet(87, true);
		System.out.println("87점보다 작은 값을 가진 부분셋 : " + set3); // 87을 포함
		
		// tailSet() : true가 기본값, 해당값을 포함하는 것이 기본값
		// tailSet() : 87점보다 큰 값을 가진 부분셋을 생성
		SortedSet<Integer> set5 = set.tailSet(87);
		System.out.println("87점보다 큰 값을 가진 부분셋 : " + set5); // 87을 포함
		
		SortedSet<Integer> set6 = set.tailSet(87, false);
		System.out.println("87점보다 큰 값을 가진 부분셋 : " + set6); // 87을 포함하지 않음

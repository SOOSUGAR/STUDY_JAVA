...
// SimpleDateFormat - 날짜 데이터를 다양한 형식으로 출력할 수 있도록 하는 클래스
public class SimpleDateFormatTest01 {
	public static void main(String[] args) {
		// 2022년 대통령 선거일, 2022-03-09 14:05:09
		...
		// 날짜는 주로 - 또는 / 로, 시간은 : 으로 연결하여 사용
		// yyyy : 년도 4자리(2022), yy : 년도 2자리(22), MM: 월 2자리(09), M : 월 1자리(9), dd : 일 2자리 , d : 일 1자리
		// HH : 24시간 2자리, hh : 12시간 2자리, h : 12시간 1자리, mm : 분 2자리, m : 분 1자리, ss : 초 2자리, s : 초 1자리 
		// a : 오전 오후 표시, E : 요일 표시
